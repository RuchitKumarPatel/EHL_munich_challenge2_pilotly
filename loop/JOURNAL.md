...
turn 1 (merge): i0004 textclf negative result -- merged clean, FAILED data-safety on merged main (docs/POSTMORTEM-textclf.md quotes PII_PERSON_7/12), merge reverted, main green at f70bf1d. i0004 -> blocked with the exact fix. Nothing merged this turn.
